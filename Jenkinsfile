pipeline {
    ...
    environment {
        ...
        TOMCAT_USER = 'Shayan' // Tomcat Manager username
        TOMCAT_PASSWORD = 'Shayan@1908' // Tomcat Manager password
    }
		    ...
		    //in this case it will be C:\ProgramData\Jenkins\.jenkins\workspace\war-deploy-jenkins-tomcat
                    ...
                    if (fileExists(warFilePath)) {
                        ...
                        bat """
                            ...
                            "${TOMCAT_URL}/manager/text/deploy?path=/robatambo&update=true"
                        """
                    } else {
